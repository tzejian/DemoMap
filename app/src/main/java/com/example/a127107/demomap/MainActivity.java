package com.example.a127107.demomap;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = (Button) findViewById(R.id.btnNormal);
        btn2 = (Button) findViewById(R.id.btnTerrain);
        btn3 = (Button) findViewById(R.id.btnSate);
